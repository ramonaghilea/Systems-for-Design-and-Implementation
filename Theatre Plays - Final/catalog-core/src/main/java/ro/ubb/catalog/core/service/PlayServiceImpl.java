...
//        List<Play> plays =  this.playRepository.findAll();
        List<Play> plays = this.playRepository.findAllWithDirector();
//        List<Play> plays = this.playRepository.findAllWithDirectorQuery();
...
//    Play play = this.playRepository.findById(id);
            Play play = this.playRepository.findAllWithDirector()
                    .stream()
...
//      play.setDirector(null);
  ...
  //                .collect(Collectors.toList());
    ...
    public List<Play> getAllPlaysReport() {
        ...
        List<Play> plays =  this.playRepository.findAllWithPerformances();
