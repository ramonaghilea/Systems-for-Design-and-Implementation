...
public class PlayController {
    ...
    Set<PlayDTO> getAllPlays()
    {
        ...
        Set<PlayDTO> result =  playConverter.convertModelsToDtos(playIService.getAllPlays());
    ...
    Set<PlayDTO> getAllPlaysReport()
    {
        ...
        Set<PlayDTO> result =  playConverter.convertModelsToDtos(playIService.getAllPlaysReport());
    ...
    PlayDTO getPlay(@PathVariable Long id)
    {
      ...
      PlayDTO result =  playConverter.convertModelToDto(playIService.getPlay(id));
        if(result == null)
    ...
    PlayDTO addPlay(@RequestBody PlayDTO playDTO){
        ...
        Play play = playConverter.convertDtoToModel(playDTO);
        log.trace("> addPlay - after DTO -> Model conversion play = {}", play);
        Play result = playIService.addPlay(play);
        log.trace("> addPlay - result = {}", result);
        PlayDTO resultModel = playConverter.convertModelToDto(result);
