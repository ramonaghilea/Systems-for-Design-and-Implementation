...
public class OfficeController {
    ...
    Set<OfficeDTO> getAllOffices()
    {
        ...
        Set<OfficeDTO> result =  officeConverter.convertModelsToDtos(officeService.getAllOffices());
        log.trace("> getAllOffices - result = {}.", result);
        return result;
    }

    @RequestMapping(value = "/offices/report")
    Set<OfficeDTO> getAllOfficesReport()
    {
        log.trace("> getAllOfficesReport - method entered.");
        Set<OfficeDTO> result =  officeConverter.convertModelsToDtos(officeService.getAllOfficesReport());
        log.trace("> getAllOfficesReport - result = {}.", result);
        return result;
    }
}
