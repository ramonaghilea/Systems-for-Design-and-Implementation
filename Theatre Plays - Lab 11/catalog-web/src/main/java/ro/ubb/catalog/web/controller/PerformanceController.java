...
//    private ActorConverter actorConverter;
    ...
    Set<PerformanceDTO> getAllPerformances()
    {
        ...
        var result =  performanceConverter.convertModelsToDtos(performanceService.getAllPerformances());
                    ...
                    @PathVariable Long actorId)
    {
        ...
        var result =  performanceConverter.convertModelToDto(performanceService.getPerformance(playId, actorId));
    ...
    PerformanceDTO addPerformance(@RequestBody PerformanceDTO performanceDTO){
        ...
        var performance = performanceConverter.convertDtoToModel(performanceDTO);
        log.trace("> addPerformance - after DTO -> Model conversion performance = {}", performance);
        var result = performanceService.addPerformance(performance);
        log.trace("> addPerformance - result = {}", result);
        var resultModel = performanceConverter.convertModelToDto(result);
